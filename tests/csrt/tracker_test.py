...
if __name__ == '__main__':
    stream = track.tracker.VideoStream(r"D:\video.mp4", True, 1, 1, ALG.MOSSE)
    ...
    stream.re_init_strategy(strategy=InitStrategy.BY_UPDATE, min_interval=3 * 1000, max_interval=10 * 1000, interval=30)
